...
<Callout>
  Contributing code to Contentlayer is the most difficult way to get involved. The project is complex and may not
  suitable for developers of all skill levels.
</Callout>

If you're interested in contributing code, please either [open an issue](https://github.com/contentlayerdev/contentlayer/issues/new) or find an issue on which you'd like to work. Add a comment stating that you'd like to work on resolving the issue, and we'll make a plan together.
