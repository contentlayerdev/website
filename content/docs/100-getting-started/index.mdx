...
<div className="grid md:grid-cols-2 gap-4 mb-20 mt-8">
  <Card title="Try it Now" icon="code">
  ...
  <Card title="Example Project" icon="github">
    [next-contentlayer-example](https://github.com/contentlayerdev/next-contentlayer-example) began as a working version of this tutorial. While it may drift over time, [this point in its history](https://github.com/contentlayerdev/next-contentlayer-example/tree/bca4b7884f5cad8963e631a2f24a19200c106495) is closest to what you will find below.

    See [the examples page](/docs/other/examples) for a full list of examples.
...
![Post Feed](/images/docs/getting-started/post-feed.png)
...
![Post Layout](/images/docs/getting-started/post-layout.png)
...
- Check out [the examples](/docs/other/examples) for inspiration on what you can do with Contentlayer.
- Explore [the guides](/docs/guides) for learning about specific techniques.
