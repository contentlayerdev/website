...
- `of` (`NestedType`): A nested document type definition. [Learn more about nested types](./define-nested-types).
...
- `default` (`string`): A default value for the field if it is empty.
- `of` (`NestedType` or `[NestedType]`): A nested document type definition. [Learn more about nested types](./define-nested-types).
