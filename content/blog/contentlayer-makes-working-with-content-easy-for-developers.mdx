...
And that’s [why we built Contentlayer](/blog/working-with-content-is-hard-for-developers). **Contentlayer makes working with content easy** for developers.
...
<BulletList>
  <BulletListItem type="check">
    Gone are the days of writing low-level content-processing logic. Instead, you set the rules and the content _just
    works_.
  </BulletListItem>
  <BulletListItem type="check">
    TypeScript type definitions are automatically generated for every piece of content.
  </BulletListItem>
  <BulletListItem type="check">
...
- Looking through [examples](https://www.contentlayer.dev/examples) and other open-source projects created with Contentlayer.
