...
TODO Add TLDR section with Contentlayer video
...
<Image
  src="https://i.imgur.com/lRrBFqd.png"
  height="162"
  width="600"
...
<BulletList
  type="cross"
  items={['Adds development complexity', 'Decreased build performance', 'Manual caching, validation, etc.']}
/>
...
<Image
  src="https://i.imgur.com/eoGZEHD.png"
  height="143"
  width="600"
  className="inline-flex w-full justify-center px-4 py-14"
/>
...
TODO add perfomance benchmark diagram

TODO merge bullet lists

<BulletList
  type="check"
  items={[
    'Build: Quick boot, live reload, incremental regeneration',
    'Test: Fast CI runs, deploy earlier',
    'Deploy: Minimize client work, improve lighthouse score',
  ]}
/>
...
<Image
  src="https://i.imgur.com/MgkpgPi.png"
  height="192"
  width="600"
  className="inline-flex w-full justify-center px-4 py-14"
/>
