...
<Image
  src="https://i.imgur.com/x5viAam.png"
  height="176"
  width="600"
  className="inline-flex w-full justify-center px-4 py-14"
/>
...
<BulletList type="cross" items={['Higher security risks', 'Lower performance risk', 'Requires DevOps knownledge']} />
...
<Image
  src="https://i.imgur.com/WwZrmo3.png"
  height="176"
  width="600"
  className="inline-flex w-full justify-center px-4 py-14"
/>
