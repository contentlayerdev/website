...
export const DocLayout: FC<{ doc: types.Doc; tree: TreeRoot }> = ({
  doc,
  tree,
}) => {
  ...
  return (
    <Layout doc={doc}>
      <div className="flex">
        ...
        <div
          className="flex-1 max-w-2xl px-12 py-8 markdown"
...
const Tree: FC<{ tree: TreeRoot; level: number; activeUrlPath: string }> = ({
  tree,
  level,
  activeUrlPath,
}) => (
        ...
        <Link href={treeNode.urlPath}>
          <a
            className={classnames(
              "py-2 px-4 no-underline text-sm block rounded-md hover:bg-gray-50 dark:hover:bg-gray-850",
