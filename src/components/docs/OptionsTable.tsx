...
export const OptionTitle: FC<{ children: ReactNode }> = ({ children }) => {
  return (
    <div className="option-title not-prose -mt-px border-t border-gray-200 bg-gray-50 p-4 pt-5 dark:border-gray-800 dark:bg-gray-900/75 md:border-r lg:border-r-0 xl:border-r">
      {children}
    </div>
  )
}
